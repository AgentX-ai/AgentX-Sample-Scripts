...
| `monitor_ops/` | Eight assertion-style scripts for monitoring operations: rules, custom scorers, webhooks, topics, session judging, judge-spend caps, OTel ingest scoring, KPI alert rules with streamed LLM calls. |
